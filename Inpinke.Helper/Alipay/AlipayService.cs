...
namespace Inpinke.Helper.Alipay
{
    ...
    public class AlipayService
    {
        ...
        public AlipayService()
        {
            ...
            _seller_email = AlipayConfig.Seller_email.Trim();
            _return_url = AlipayConfig.Return_url.Trim();
            _notify_url = AlipayConfig.Notify_url.Trim();
        }
        ...
        public string Create_direct_pay_by_user(SortedDictionary<string, string> sParaTemp)
        {
            ...
            //构造表单提交HTML数据
            strHtml = AlipaySubmit.BuildFormHtml(sParaTemp, GATEWAY_NEW, "post", strButtonValue);
        ...
        {
            string url = GATEWAY_NEW + "service=query_timestamp&partner=" + AlipayConfig.Partner;
            string encrypt_key = "";
